...
@njit
def evolve_quantum_time_series(S, neighbour_list, z5, v5, z6, v6, t_series, M_series, dt, gamma, lam, J_mu, K_mu, q_pref, dt_q, amp5, amp6, iterations, stride):
    n_sites = S.shape[0]
    ...
    for step in range(iterations):
        ...
        heun_step(S, S_new, S_tilde, r, neighbour_list, H_eff, H_eff_tilde, dS1, dS2, dt, gamma, lam, J_mu, K_mu)
...
@njit
def evolve_classical_time_series(S, neighbour_list, t_series, M_series, dt, gamma, lam, J_mu, K_mu, c_pref, iterations, stride):
    n_sites = S.shape[0]
...
@njit
def evolve_deterministic_time_series(S, neighbour_list, t_series, M_series, dt, gamma, lam, J_mu, K_mu, iterations, stride):
    n_sites = S.shape[0]
